...
class IssuedClothingRepository extends BaseRepository {
    ...
    public function create(IssuedClothing $issuedClothing) {
        ...
        $stmt->bindValue(':id_wydania', $issuedClothing->getIdWydania());
        $stmt->bindValue(':id_ubrania', $issuedClothing->getIdUbrania());
        $stmt->bindValue(':id_rozmiaru', $issuedClothing->getIdRozmiaru());
        $stmt->bindValue(':ilosc', $issuedClothing->getIlosc());
        $stmt->bindValue(':data_waznosci', $issuedClothing->getDataWaznosci());
        $stmt->bindValue(':status', $issuedClothing->getStatus());
        return $stmt->execute();
    }
